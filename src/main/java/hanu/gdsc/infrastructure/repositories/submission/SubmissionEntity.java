    ...
    public static Submission toDomain(SubmissionEntity submissionEntity, ObjectMapper objectMapper) {
        try {
            ...
            return constructor.newInstance(
                    new hanu.gdsc.domain.models.Id(submissionEntity.getId()),
                    new hanu.gdsc.domain.models.Id(submissionEntity.getProblemId()),
                    ...
                    new hanu.gdsc.domain.models.Id(submissionEntity.coderId),
