...
import hanu.gdsc.domain.models.Status;
    ...
    public static SubmissionEvent toDomain(SubmissionEventEntity submissionEventEntity) {
        ...
        try {
            ...
            return constructor.newInstance(
                    new hanu.gdsc.domain.models.Id(submissionEventEntity.getId()),
                    new hanu.gdsc.domain.models.Id(submissionEventEntity.getProblemId()),
                    Status.valueOf(submissionEventEntity.getStatus()),
                    new hanu.gdsc.domain.models.Id(submissionEventEntity.getCoderId())
            );
        } catch (Exception e) {
            e.printStackTrace();
            throw new Error(e);
